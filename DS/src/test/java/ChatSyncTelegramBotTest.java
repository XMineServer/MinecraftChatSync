...
import ru.hackaton.chatsync.ds.ChatSyncDSPlugin;
import ru.hackaton.chatsync.ds.ChatSyncTelegramBot;
...
// TODO REPLACE ALL TELEGRAM/TG TO DISCORD/DS
class ChatSyncDiscordBotTest {

    private ServerMock server;
    private ChatSyncDSPlugin plugin;

    @BeforeEach
    void setUp() {
        System.setProperty("mockbukkit", "true");
        server = MockBukkit.mock();
        plugin = MockBukkit.load(ChatSyncDSPlugin.class);
    }
...
//        msg.setText("hello from ds group");
//
//        Chat chat = new Chat();
//        chat.setId(-100L);
//        chat.setType("group");
...
//        assertNotNull(event);
//        assertEquals("hello from ds group", event.getMessage());
...
//        PlayerMock online = server.addPlayer("dsUser");
//
//        Update update = new Update();
//        Message msg = new Message();
...
//        assertEquals("dsUser", ev.getPlayer().getName());
//    }
//
//    @Test
